...
class SenderIDAdmin(admin.ModelAdmin):
    list_display = ['name', 'user', 'visibility', 'provider', 'platform_status', 'termii_dnd_whitelisted', 'created_at']
    list_filter = ['visibility', 'provider', 'platform_status', 'termii_dnd_whitelisted']
